...
import add_shield from "./add-shield.svg";
...
import aws_ec2_vpc from "./aws-ec2-vpc.svg";
import aws_ecr_repository from "./aws-ecr-repository.svg";
...
import deployment_success from "./deployment-success.svg";
import deployment from "./deployment.svg";
import dex from "./dex.svg";
import diff from "./diff.svg";
import discord from "./discord.svg";
import disk_failed from "./disk-failed.svg";
import disk_success from "./disk-success.svg";
...
import down_bordered from "./down-bordered.svg";
import down_database from "./down-database.svg";
import down_shield from "./down-shield.svg";
import down from "./down.svg";
import download_cloud from "./download-cloud.svg";
...
import id_not_verified from "./id-not-verified.svg";
import id_verified from "./id-verified.svg";
import ifttt from "./ifttt.svg";
import import_icon from "./import.svg";
...
import loadbalancer from "./loadbalancer.svg";
...
import remove_firewall from "./remove-firewall.svg";
...
import submit_for_approval from "./submit-for-approval.svg";
...
import unhealthy from "./unhealthy.svg";
import unlock from "./unlock.svg";
import up_bordered from "./up-bordered.svg";
import up_database from "./up-database.svg";
import up_shield from "./up-shield.svg";
...
import workdflow from "./workdflow.svg";
...
export const Icons = {
  ...
  diff: diff,
  discord: discord,
  "disk-failed": disk_failed,
  "disk-success": disk_success,
  disk: disk,
  django: django,
  dns: dns,
  ...
  "down-bordered": down_bordered,
  "down-database": down_database,
  "down-shield": down_shield,
  down: down,
  "download-cloud": download_cloud,
  download: download,
  dynatrace: dynatrace,
  ec2: ec2,
  ecr: ecr,
  ...
  ibm: ibm,
  icmp: icmp,
  "id-not-verified": id_not_verified,
  ...
  "remove-firewall": remove_firewall,
  ...
  unhealthy: unhealthy,
  unlock: unlock,
  "up-bordered": up_bordered,
  "up-database": up_database,
  "up-shield": up_shield,
  up: up,
  upload: upload,
  user: user,
