...
export const aliases: IconMap = {
  ...
  "gcp-cloudbilling-projectbillinginfo": "gcp-billing",
  "gcp-cloudkms-cryptokey": "gcp-key-management-service",
  "gcp-cloudkms-cryptokeyversion": "gcp-key-management-service",
  "gcp-cloudkms-keyring": "gcp-key-management-service",
  "gcp-cloudresourcemanager-project": "gcp-project",
  "gcp-compute-address": "gcp-compute-engine",
  "gcp-compute-disk": "gcp-persistent-disk",
  "gcp-compute-firewall": "gcp-cloud-firewall-rules",
  "gcp-compute-forwardingrule": "gcp-cloud-load-balancing",
  "gcp-compute-globaladdress": "gcp-compute-engine",
  "gcp-compute-httphealthcheck": "gcp-compute-engine",
  "gcp-compute-instance": "gcp-compute-engine",
  "gcp-compute-instancegroup": "gcp-compute-engine",
  "gcp-compute-instancegroupmanager": "gcp-compute-engine",
  "gcp-compute-instancetemplate": "gcp-compute-engine",
  "gcp-compute-network": "gcp-virtual-private-cloud",
  "gcp-compute-project": "gcp-project",
  "gcp-compute-route": "gcp-cloud-routes",
  "gcp-compute-router": "gcp-cloud-router",
  "gcp-compute-subnetwork": "gcp-virtual-private-cloud",
  "gcp-compute-targetpool": "gcp-cloud-load-balancing",
  "gcp-container-cluster": "gcp-google-kubernetes-engine",
  "gcp-container-nodepool": "gcp-google-kubernetes-engine",
  "gcp-dataform-repository": "gcp-repos",
  "gcp-dataform-workspace": "gcp",
  "gcp-datamigration-connectionprofile": "gcp-database-migration-service",
  "gcp-dataplex-entrygroup": "gcp-dataplex",
  "gcp-dns-managedzone": "gcp-cloud-dns",
  "gcp-dns-resourcerecordset": "gcp-cloud-dns",
  "gcp-iam-serviceaccount": "gcp-identity-and-access-management",
  "gcp-iam-serviceaccountkey": "gcp-identity-and-access-management",
  "gcp-logging-link": "gcp-cloud-logging",
  "gcp-logging-logbucket": "gcp-cloud-logging",
  "gcp-logging-logsink": "gcp-cloud-logging",
  "gcp-logging-recentquery": "gcp-cloud-logging",
  "gcp-monitoring-alertpolicy": "gcp-cloud-monitoring",
  "gcp-monitoring-notificationchannel": "gcp-cloud-monitoring",
  "gcp-networkmanagement-connectivitytest": "gcp-connectivity-test",
  "gcp-osconfig-ospolicyassignment": "gcp-os-configuration-management",
  "gcp-pubsub-subscription": "gcp-pubsub",
  ...
  "gcp-sqladmin-instance": "gcp-cloud-sql",
  "gcp-storage-bucket": "gcp-cloud-storage",
