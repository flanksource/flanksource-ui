...
export const CanaryInterfaceMinimal = React.memo(
  ({ checks = [], searchParams, onFilterCallback, onLabelFiltersCallback }) => {
    const [filteredChecks, setFilteredChecks] = useState(checks);
    const [checksForTabGeneration, setChecksForTabGeneration] =
      useState(checks);
...
CanaryInterfaceMinimal.displayName = "CanaryInterfaceMinimal";
