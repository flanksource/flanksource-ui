    ...
    {({ open }) => (
      <>
        ...
        <div className={`${label && "mt-1"} relative h-full`}>
          <Listbox.Button
            className={`relative cursor-pointer w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-1 text-left  focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm
