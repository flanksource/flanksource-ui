export default function IncidentDetailsPageSkeletonLoader() {
  return (
    <div className="flex flex-col flex-1 h-full animate-pulse">
      <div className="flex flex-row h-auto w-full p-3 space-x-4 items-end border-b border-gray-300 bg-gray-50">
        <div className="w-36 h-full rounded-md bg-gray-200" />
        <div className="flex-1" />
        <div className="h-12 w-12 rounded-full bg-gray-200" />
      </div>
      <div className="overflow-y-auto h-full w-full border-t-gray-300 bg-gray-50">
        <div className="pl-6">
          <div className="flex flex-row min-h-full h-auto mt-2">
                ...
                {Array.of(1, 2, 3).map((v) => (
                  <div key={`action-plan-row-${v}`}>
                    <div className="flex flex-row items-center h-[3.3125rem] rounded-lg space-x-2 my-1 bg-gray-200">
                      <div className="w-8 h-8 m-1 rounded-full bg-gray-300"></div>
            ...
            <div className="flex flex-col w-[35rem] border-l-gray-200">
              <div className="flex m-4 mt-2 justify-between border-b-gray-200">
                <div className="w-20 h-9 rounded-md bg-gray-200" />
                <div className="w-[5.625rem] h-9 rounded-md bg-gray-200" />
              </div>
              <div className="grid grid-cols-1-to-2 gap-6 items-center mt-5 mx-4">
              ...
              {Array.of(1, 2, 3).map((v) => (
                <div
                  ...
                  className="grid grid-cols-1-to-2 gap-6 items-center mt-2 mb-[0.375rem] mx-4"
                >
                  <div className="w-full h-6 rounded-md bg-gray-200" />
                  <div className="w-full h-[2.375rem] rounded-md bg-gray-200" />
                </div>
              ))}
              <div className="px-4 pt-0 pb-[.6rem] mt-2 mb-4 border-b border-b-gray-200">
                <div className="w-36 h-9 rounded-md bg-gray-200" />
              </div>
              <div className="w-32 h-5 my-2 mx-4 rounded-md bg-gray-200" />

              <div className="px-4 pt-0 pb-[.6rem] mt-4 mb-2 border-b border-b-gray-200">
                <div className="w-52 h-9 rounded-md bg-gray-200" />
              </div>
              <div className="w-48 h-5 my-2 mx-4 rounded-md bg-gray-200" />
              <div className="px-4 pt-0 pb-[.6rem] mt-6 mb-2 border-b border-b-gray-200">
                <div className="w-52 h-9 rounded-md bg-gray-200" />
              </div>
              <div className="mx-4">
                <div className="w-full h-9 my-1.5 rounded-md bg-gray-200" />
                <div className="w-full h-9 my-1.5 rounded-md bg-gray-200" />
              </div>
            </div>
          </div>
